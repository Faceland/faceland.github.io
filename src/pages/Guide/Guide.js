  ...
  return (
    <div className="App Guide">
      ...
      <div className="basicPage">
        ...
        <Accordion
          style={{ backgroundColor: '#57423F', borderRadius: 0 }}
          allowMultipleExpanded={true}
          allowZeroExpanded={true}
          preExpanded={['basicOne']}
        >
          <AccordionItem uuid="basicOne">
            <AccordionItemHeading>
              <AccordionItemButton>What Is Faceland?</AccordionItemButton>
            </AccordionItemHeading>
            <AccordionItemPanel>
              <p>
          ...
          <AccordionItem>
            <AccordionItemHeading>
              <AccordionItemButton>How Do I Play?</AccordionItemButton>
            </AccordionItemHeading>
            <AccordionItemPanel>
              <Accordion
              ...
              >
                <AccordionItem>
                  <AccordionItemHeading>
                    <AccordionItemButton>How To Connect</AccordionItemButton>
                  </AccordionItemHeading>
                  <AccordionItemPanel>
                    <p>
                ...
                <AccordionItem>
                  <AccordionItemHeading>
                    <AccordionItemButton>How To Fight</AccordionItemButton>
                  </AccordionItemHeading>
                  <AccordionItemPanel>
                    <p>
                      A lot of the appeal of Faceland comes from combat! Try
                      attacking normally or pressing your number keys (1-3) to
          ...
          <AccordionItem>
            <AccordionItemHeading>
              <AccordionItemButton>Skills And Leveling</AccordionItemButton>
            </AccordionItemHeading>
            <AccordionItemPanel>
              <p>
          ...
          <AccordionItem>
            <AccordionItemHeading>
              <AccordionItemButton>Quests And QuestPoints</AccordionItemButton>
            </AccordionItemHeading>
            <AccordionItemPanel>
              <p>
